    ...
    return (
        ...
        function t(a) {
                    ...
                    return (
                        n.forEach(function (e) {
                            e.classList.remove('medium-zoom-image'),
                                e.dispatchEvent(m('medium-zoom:detach', { detail: { zoom: j } }));
                        }),
                        ...
                        r = function () {
                            ...
                            if (S.container)
                                if (S.container instanceof Object)
                                    ...
                                    var d = (
                                            o(S.container) ? S.container : document.querySelector(S.container)
                                ...
                                if (
                                    ...
                                    T.zoomed.addEventListener('transitionend', function t() {
                                        (A = !1),
                                            ...
                                            T.original.dispatchEvent(m('medium-zoom:opened', { detail: { zoom: j } })),
                                            e(j);
                                    }),
                    ...
                    return new c(function (e) {
                        if (!A && T.original) {
                            (A = !0),
                                ...
                                T.template &&
                                    ((T.template.style.transition = 'opacity 150ms'), (T.template.style.opacity = 0)),
            ...
            '[object Object]' === Object.prototype.toString.call(a) ? (S = a) : (a || 'string' == typeof a) && v(a),
                (S = e({ margin: 0, background: '#fff', scrollOffset: 40, container: null, template: null }, S));
